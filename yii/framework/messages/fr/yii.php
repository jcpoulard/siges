...
return array (
  ...
  '{attribute} is too big (maximum is {max}).' => '{attribute} est trop grand(e) (maximum : {max}).',
  '{attribute} is too long (maximum is {max} characters).' => '{attribute} est trop long(ue) (maximum : {max} caractères).',
  '{attribute} is too short (minimum is {min} characters).' => '{attribute} est trop court(e) (minimum : {min} caractères).',
  '{attribute} is too small (minimum is {min}).' => '{attribute} est trop petit(e) (minimum : {min}).',

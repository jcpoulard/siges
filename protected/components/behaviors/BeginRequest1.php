...
class BeginRequest1 extends CBehavior {
    ...
    public function attach($owner) {
       ...
       //Profil
        if (isset($_POST['_prof']))
        {
           Yii::app()->session['profil_selector']= $_POST['_prof'];
            $app->user->setState('_prof', $_POST['_prof']);
            
          
        }
        elseif ($app->user->hasState('_prof'))
          {
          	  Yii::app()->session['profil_selector']= $app->user->getState('_prof'); 
          } 

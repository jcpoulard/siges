	        	...
	        	if(($tmwen==true)&&($this->room_id!=null)&&($this->idLevel!=null)&&($this->section_id!=null)&&($this->idShift!=null))		
			      { echo '<div class="" style=" padding-left:0px;margin-right:240px; margin-bottom:-45px; ';//-20px; ';
				   ...
				   if($this->messageEvaluation_id)
				      echo '<span style="color:red;" >'.Yii::t('app','Please define the Last Evaluation Period.').'</span>'.'<br/>';
           ...
           if(($this->room_id!=null)&&($this->idLevel!=null)&&($this->section_id!=null)&&($this->idShift!=null))		
			      {
				      if($this->noStud===1)
						{              
		                        echo CHtml::submitButton(Yii::t('app', 'View'),array('name'=>'create','class'=>'btn btn-warning')); 
...
<?php
...
else
  {
				  ...
				  echo '<div class="" style=" padding-left:0px;margin-right:240px; margin-bottom:-13px; ">';
				   	  
				   echo '<table class="responstable" style="width:100%; background-color:#F8F8c9;  ">
					   <tr>
					    <td style="text-align:center;">';
					     	
				   echo '<span style="color:red;" >'.Yii::t('app','Your system configuration does not allow this operation.').'</span>'.'<br/>';

   ...
   { if((isset($this->evaluation_id))&&($this->evaluation_id!=""))
      {
		...
		if($passing_grade!=null) // passing grade is set for this level
	     {	$noPassingGrade=false;		 	      		      
		  //total students
		   $dataProvider_s2=Persons::model()->searchStudentsForGrades($this->idShift,$this->section_id,$this->idLevel,$this->room_id,$acad_sess);
				  ...
				  $person_s2=$dataProvider_s2->getData();
						...
						foreach($person_s2 as $stud2)
						  { 
							 ...
							 $dataProvider_s2 = $this->getStudentAverageInfo($studentID,$this->room_id,$this->idLevel, $this->idShift, $this->section_id,$this->evaluation_id,$acad_sess);
...
if((isset($this->room_id))&&($this->room_id!=""))
   { if((isset($this->evaluation_id))&&($this->evaluation_id!=""))
      {	
		     		  ...
		     		  $dataProvider=Persons::model()->searchStudentsForGrades($this->idShift,$this->section_id,$this->idLevel,$this->room_id,$acad_sess);
		...
		$averageInfo= $this->getStudentAverageInfo($this->student_id,$this->room_id,$this->idLevel, $this->idShift, $this->section_id,$this->evaluation_id,$acad_sess);

...
class HomeworkSubmissionController extends Controller
{
	...
	public function actionCreate()
	{
	   ...
	   $submission='documents/homework_submission';
...
$acad=Yii::app()->session['currentId_academic_year'];   
		...
		$model=new HomeworkSubmission('searchSubmitedHomeworkByStudentId('.$this->student_id,$acad_sess.')');
		...
		if(isset($_GET['HomeworkSubmission']))
			$model->attributes=$_GET['HomeworkSubmission'];
                ...
                $this->exportCSV($model->searchSubmitedHomeworkByStudentId($this->student_id,$acad_sess), array(
...
$acad=Yii::app()->session['currentId_academic_year']; 
	...
	//return print_r('<br/><br/><br/><br/><br/><br/><br/>****************************************'.$path);		
		return $path;
...
//************************  getUserInfo ******************************/		
	...
	{    $modelH= new Homework();
		  ...
		  $modelHomework=$modelH->findAll(array('alias'=>'hw','select'=>'hw.id,hw.title',
                                    ...
                                    //'params'=>array(':idHomework'=>$id_homework),
                               ));
...
//************************  loadRoomByIdTeacher($id_teacher,$acad) ******************************/
	...
	{    $modelRoom= new Rooms();
		  ...
		  $modelPersonRoom=$modelRoom->findAll(array('alias'=>'r',
                                     ...
                                     'join'=>'left join room_has_person rh on(rh.room= r.id) left join courses c on(rh.room=c.room) left join academicperiods ap on(ap.id=c.academic_period)',
									 'condition'=>'c.teacher='.$id_teacher.' AND c.academic_period='.$acad,

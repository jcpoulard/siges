...
<div id="dash">
          ...
          <div class="span3"><h2>
                <?php echo Yii::t('app','Update contact info for : {name}',array('{name}'=>$model->person0->fullName)); ?>
				           ...
				           { if($_GET['from']=='stud')
				             ...
				             elseif($_GET['from']=='teach')
				               {  echo CHtml::link($images,array('/academic/persons/viewForReport?id='.$_GET['pers'].'&isstud=0&from=teach'));
				                   $this->back_url='/academic/persons/viewForReport?id='.$_GET['pers'].'&isstud=0&from=teach';
				                 }
				                 elseif($_GET['from']=='emp')

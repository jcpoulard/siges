...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('total_grade')); ?>:</b>
	<?php echo CHtml::encode($data->total_grade); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('mension')); ?>:</b>
	<?php echo CHtml::encode($data->mension); ?>
	<br />

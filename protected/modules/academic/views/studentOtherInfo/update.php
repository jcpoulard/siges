...
<div id="dash">
         ...
         <div class="span3"><h2>
            <?php echo Yii::t('app','Update more info for student'); ?> 
         </h2> </div>
                     ...
                     if(isset($_GET['from']))
                      {
                        ...
                        { echo CHtml::link($images,array('/academic/studentOtherInfo/index'));
                          $this->back_url='/academic/studentOtherInfo/index';
                        }

...
Yii::app()->clientScript->registerScript('searchApproved', "
...
<?php  $content='';
	...
	$content= $model->searchApproved($acad_sess)->getData();
...
$pageSize=Yii::app()->user->getState('pageSize',Yii::app()->params['defaultPageSize']);
	...
	'id'=>'postulant-grid',
	'dataProvider'=>$model->searchApproved($acad_sess),
	//'filter'=>$model,
	...
	'columns'=>array(
		...
		array(
                    'name' => 'first_name',
                    'type' => 'raw',
                    'value'=>'CHtml::link($data->first_name,Yii::app()->createUrl("/academic/postulant/viewAdmissionDetail",array("id"=>$data->id,"part"=>"applis","pg"=>"")))',
		...
		array(
                    'name' => 'last_name',
                    'type' => 'raw',
                    'value'=>'CHtml::link($data->last_name,Yii::app()->createUrl("/academic/postulant/viewAdmissionDetail",array("id"=>$data->id,"part"=>"applis","pg"=>"")))',
                    'htmlOptions'=>array('width'=>'150px'),
                     ),
		array(
            'name'=>'gender',
		...
		array(
			'class'=>'CButtonColumn',
                        ...
                        'buttons'=>array('update'=>array('label'=>'<span class="fa fa-pencil-square-o"></span>',
                            'imageUrl'=>false,
                            'url'=>'Yii::app()->createUrl("/academic/postulant/update?id=$data->id&part=decisi&from=")',

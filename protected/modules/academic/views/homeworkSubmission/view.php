...
<div id="dash">
		<div class="span3"><h2>
		     <?php 
               ...
               $date=$model->homework->given_date;
               
      		        echo Yii::t('app','Submission Homework').': '.$course ?>
		   ...
		   <div class="span3">
             ...
             <div class="span4">
                 ...
                 $images = '<i class="fa fa-arrow-left"> &nbsp;'.Yii::t('app','Cancel').'</i>';
				    ...
				    echo CHtml::link($images,array('/academic/homeworkSubmission/index/isstud/1/from/stud'));
...
echo '<div style="clear:both"><iframe src="'.Yii::app()->baseUrl.'/ViewerJS/#../homework_submission/'.$path.'/'.$model->attachment_ref.'" width=\'90%\' height=\'650\' allowfullscreen webkitallowfullscreen ></iframe></div> '; //height=\'350\' allowfullscreen webkitallowfullscreen ></iframe></div> ';

...
<?php
/*
    if(isset($_GET['el']) && $_GET['el']=='emp'){
        if($modelC->email != null || $modelC->email != ""){
           // 
?>

<h1><?php echo Yii::t('app','Send email for {name1}',array('{name1}'=>$modelC->contact_name));  ?></h1>
...
<?php 
        ...
        if(isset($_GET['stud']))
                $id_contact = $_GET['stud'];
        $link = '<i class="btn btn-success">'.CHtml::link(Yii::t('app','Create email for name1',array('name1'=>$modelC->contact_name)), array('contactinfo/update','id'=>$id_contact,'from'=>'emp')).'</i>';
        echo '<h4 class="alert alert-info">'.Yii::t('app','Imposible to send email to name1, name1 don\'t have a valid email setup.<br/> Please addEmail',array('name1'=>$modelC->contact_name,'addEmail'=>$link)).'</h4>';
?>
...
<?php 
    ...
    if($modelP->email != null  || $modelP->email != ""  ){
?>
<h1><?php echo Yii::t('app','Send email for {name1}',array('{name1}'=>$modelP->fullName));  ?></h1>
...
<?php
         ...
         if(isset($_GET['from']) && $_GET['from']=='stud'){
            $link = '<i class="btn btn-success">'.CHtml::link(Yii::t('app','Create email for name1',array('name1'=>$modelP->fullName)), array('persons/update','id'=>$modelP->id,'pg'=>'vrlr','isstud'=>1,'from'=>'stud')).'</i>';
        }
        elseif (isset($_GET['from']) && $_GET['from']=='teach') {
            $link = '<i class="btn btn-success">'.CHtml::link(Yii::t('app','Create email for name1',array('name1'=>$modelP->fullName)), array('persons/update','id'=>$modelP->id,'pg'=>'vrlr','isstud'=>0,'from'=>'teach')).'</i>';
        }
        else{
            $link = '<i class="btn btn-success">'.CHtml::link(Yii::t('app','Create email for name1',array('name1'=>$modelP->fullName)), array('persons/update','id'=>$modelP->id,'pg'=>'vrlr','from'=>'emp')).'</i>';
        }
        /*if(isset($_GET['de']) && $_GET['de']=='ci' && isset($_GET['el'])){
            if(isset($_GET['stud'])){
                $id_contact = $_GET['stud'];
           $link = '<i class="btn btn-success">'.CHtml::link(Yii::t('app','Create email for name1',array('name1'=>$modelP->fullName)), array('contactinfo/update','id'=>$id_contact,'from'=>'stud')).'</i>';
            }
         if($_GET['from']=='teach'){
            if(isset($_GET['stud'])){
                $id_contact = $_GET['stud'];
            $link = '<i class="btn btn-success">'.CHtml::link(Yii::t('app','Create email for name1',array('name1'=>$modelP->fullName)), array('contactinfo/update','id'=>$id_contact,'from'=>'teach')).'</i>';
            }
        } 
        ...
        */
       // echo '<h4 class="alert alert-info">'.Yii::t('app','Imposible to send email to name1, name1 don\'t have a valid email setup.<br/> Please addEmail',array('name1'=>$modelP->fullName,'addEmail'=>$link)).'</h4>';
   // }  */
?>
<?php 
   // }

...
<div id="dash">
  ...
  <?php
			if((isset($_GET['isstud'])) && ($_GET['isstud']==1)) echo '<h2><span class="fa fa-download fa-2x"> '.Yii::t('app','Room affectation').'</span> </h2>'; 
			 ?>   
                     ...
                     $images = '<i class="fa fa-arrow-left"> &nbsp;'.Yii::t('app','Cancel').'</i>';
                       ...
                       if(isset($_GET['pg']))
					     {  if($_GET['pg']=='lr')
							...
							elseif($_GET['pg']=='lrl')
							       echo CHtml::link($images,array('list','isstud'=>1,'pg'=>'lr','from'=>'stud'));
								 elseif($_GET['pg']=='l')
...
echo $this->renderPartial('_roomAffectation', array(
	'model'=>$model,
	'form' =>$form
	)); ?>

	...
	'id'=>'persons-form',
					         ...
					         $modelPerson= new Persons();
							    if(isset($this->person_id))
							       echo $form->dropDownList($modelPerson,'id',$this->loadChildren($userName), array('onchange'=> 'submit()', 'options' => array($this->person_id=>array('selected'=>true)))); 
							    else
								  { 
...
<div class="row-fluid">
    <?php echo Yii::t('app','Please select a student to see his/her discipline record.'); ?>
</div>

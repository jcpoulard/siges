...
<div id="dash">
    <div class="span3">
        <h2><?php echo Yii::t('app','Students data migration'); ?></h2> 
    </div>
...
<div>
    <div class="row-fluid">
        ...
        <div class="span6 well" style="height: 90px;">
            <label>
      ...
      ?>       
        ...
        <div class="span6 well" style="height: 90px;">
            <p>
                <?php echo Yii::t('app','Please upload a csv file using the following format in this specific order : Last name - First name - Gender - Birthday - Code.<br/>Birthday need to be in the format of day-month-year (22-12-2014)'); ?>
            </p> 
        </div>
    </div>
</div>
   ...
   // Verrifie que le fichier existe et a ete uploade 
    ...
    <form method="POST">
        ...
        <?php
            ...
            array('prompt'=>Yii::t('app','-- Please select a room --'),'name'=>'room')
            );
        ?>
        ...
        <div class="grid-view span12">
        <table class="items responstable">
            <th>
                #
            </th>
                                ...
                                if($flag){
                                    ...
                                    for ($c=0; $c < $num; $c++) {
                                        ...
                                        if($c==2){
                                            ...
                                            echo '<td> <input size="10"  type="text" name="last_name'.$row.'" value="'.$this->data[$c].'"></td>';
                                        }elseif($c==1){
                                            echo '<td> <input type="text" name="first_name'.$row.'" value="'.$this->data[$c].'"></td>';
                                        }elseif($c==3){
                                            echo '<td> <input type="text" style="width: 100px;" name="birthday'.$row.'" value="'.$this->data[$c].'"></td>';
                                        }elseif($c==4){
                                            echo '<td> <input type="text" style="width: 100px;" name="code'.$row.'" value="'.$this->data[$c].'"></td>';
                                        }
    ...
    ?>
        ...
        <button name="btnFinish" class="btn btn-warning" type="submit"><?php echo Yii::t('app','Migrate students');  ?></button>

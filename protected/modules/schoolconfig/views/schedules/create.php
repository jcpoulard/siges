...
<div id="dash">
          ...
          <div class="span3"><h2> <?php echo Yii::t('app','Create Schedules'); ?></h2> </div>
		   ...
		   <div class="span3">
             <div class="span4">
                     ...
                     $images = '<i class="fa fa-arrow-left"> &nbsp;'.Yii::t('app','Cancel').'</i>';
                       ...
                       {  
                          echo CHtml::link($images,array('/schoolconfig/schedules/index')); 
                          $this->back_url='/schoolconfig/schedules/index';

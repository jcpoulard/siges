...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_charge_description'); ?>
		<?php echo $form->textField($model,'id_charge_description'); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'created_by',array('size'=>60,'maxlength'=>65)); ?>
	</div>

...
$gridWidget = $this->widget('groupgridview.GroupGridView', array(
	...
	'columns'=>array(
		...
		array('name'=>'student0.fullName',
			...
			'value'=>'CHtml::link($data->student0->fullName,Yii::app()->createUrl("/billings/billings/view",array("id"=>lastBillingTransactionID($data->student, '.$acad_sess.'),"ri"=>0,"part"=>"rec","stud"=>$data->student,"from1"=>"sho")))',           
                    ),

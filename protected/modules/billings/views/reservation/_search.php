...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'postulant_student'); ?>
		<?php echo $form->textField($model,'postulant_student'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'is_student'); ?>
		<?php echo $form->textField($model,'is_student'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'already_checked'); ?>
		<?php echo $form->textField($model,'already_checked'); ?>
	</div>

...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('postulant_student')); ?>:</b>
	<?php echo CHtml::encode($data->postulant_student); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('already_checked')); ?>:</b>
	<?php echo CHtml::encode($data->already_checked); ?>
	<br />

...
<div  id="resp_form_siges">
        ...
        <div class="col-3">
            <label id="resp_form"> 
                   ...
                   <?php echo $form->labelEx($model,'income_description'); ?>

                        <?php echo $form->textField($model,'income_description',array('size'=>60,'maxlength'=>65,'placeholder'=>Yii::t('app','Income Description'))); ?>
		                <?php echo $form->error($model,'income_description'); ?>
         ...
         <div class="col-3">
            <label id="resp_form"> 
                  ...
                  <?php echo $form->dropDownList($model,'category',$this->loadCategoryIncome());  ?>

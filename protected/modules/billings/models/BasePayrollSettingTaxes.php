 ...
 * @property integer $id
 * @property integer $id_paroll_set
 ...
 */
class BasePayrollSettingTaxes extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_paroll_set, id_taxe', 'required'),
			array('id_paroll_set, id_taxe', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, id_paroll_set, id_taxe', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'idParollSet' => array(self::BELONGS_TO, 'PayrollSettings', 'id_paroll_set'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_paroll_set',$this->id_paroll_set);

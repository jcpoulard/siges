...
?>
<?php
$this->pageTitle = Yii::app()->name .' - '.Yii::t('app','Manage sections');
...
<div id="dash">
   <div class="span3"><h2>
        <?php echo Yii::t('app','Manage sections');?>
...
$gridWidget = $this->widget('zii.widgets.grid.CGridView', array(
	...
	'dataProvider'=>$model->search(),
        ...
        'emptyText'=>Yii::t('app','No section found'),
        'summaryText'=>Yii::t('app','View section from {start} to {end} (total of {count})'),
	...
	'columns'=>array(
		...
		array(
			...
			'template'=>$template,
                        ...
                        'onchange'=>"$.fn.yiiGridView.update('sections-grid',{ data:{pageSize: $(this).val() }})",
            )),

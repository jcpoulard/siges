...
<div id="dash">
          ...
          <div class="span3"><h2>
              <?php echo Yii::t('app','Observation reportcard'); ?>
   ...
   ?>
              ...
              <?php
                 ...
                 $images = '<i class="fa fa-plus">&nbsp;'.Yii::t('app','Update').'</i>';
                           // build the link in Yii standard
                 echo CHtml::link($images,array('/configuration/reportcardObservation/update')); 
               ?>
              </div>
			...
			'class'=>'CButtonColumn',
			  'template'=>$template,
                         'buttons'=>array('update'=>array('label'=>'<span class="fa fa-pencil-square-o"></span>',
                            'imageUrl'=>false,
                            'url'=>'Yii::app()->createUrl("/configuration/reportcardObservation/update?id=$data->id")',
                      ...
                      'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,20=>20,50=>50,100=>100,100000=>Yii::t('app','all')),array(
                             'onchange'=>"$.fn.yiiGridView.update('reportcard-observation-grid',{ data:{pageSize: $(this).val() }})",
                             )),
		),
	),
)); 

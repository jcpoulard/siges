...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'start_range'); ?>
		<?php echo $form->textField($model,'start_range'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'end_range'); ?>
		<?php echo $form->textField($model,'end_range'); ?>
	</div>

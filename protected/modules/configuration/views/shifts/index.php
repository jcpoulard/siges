...
?>
<?php
$this->pageTitle = Yii::app()->name .' - '.Yii::t('app','Manage shifts');
...
<div id="dash">
   <div class="span3"><h2>
       <?php echo Yii::t('app','Manage shifts');?>
...
<?php 
	...
	Yii::app()->clientScript->registerScript('search', "
			...
			$('.search-form form').submit(function(){
				$.fn.yiiGridView.update('shifts-grid', {
data: $(this).serialize()
});
				return false;
				});
...
$gridWidget = $this->widget('zii.widgets.grid.CGridView', array(
	...
	'dataProvider'=>$model->search(),
        ...
        'emptyText'=>Yii::t('app','No shift found'),
        'summaryText'=>Yii::t('app','View shift from {start} to {end} (total of {count})'), 
		...
		array(
			'class'=>'CButtonColumn',
                    ...
                    'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,20=>20,50=>50,100=>100),array(
                          'onchange'=>"$.fn.yiiGridView.update('shifts-grid',{ data:{pageSize: $(this).val() }})",
            )),

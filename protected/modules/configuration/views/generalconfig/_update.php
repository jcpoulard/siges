...
<div  id="resp_form_siges">
 ...
 <div class="col-3">
		...
		<?php echo $form->textField($model,'name',array('size'=>60,'maxlength'=>64,'placeholder'=>Yii::t('app','Name'),  'readOnly'=>true));
		      ?>
...
<div class="col-3">
		...
		<?php echo $form->textField($model,'item_value',array('size'=>60)); ?>
...
<div class="col-2">
		...
		<?php echo $form->textArea($model,'description',array('rows'=>6, 'cols'=>50,  'readOnly'=>true)); ?>
...
<div class="col-2">
		...
		<?php echo $form->textArea($model,'english_comment',array('rows'=>6, 'cols'=>50,  'readOnly'=>true)); ?>

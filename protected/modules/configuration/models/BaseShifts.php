 ...
 */
class BaseShifts extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return BaseShifts the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('shift_name', 'required'),
			array('shift_name, create_by, update_by', 'length', 'max'=>45),
			array('time_start, time_end, date_created, date_updated', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, shift_name, time_start, time_end, date_created, date_updated, create_by, update_by', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'rooms' => array(self::HAS_MANY, 'Rooms', 'shift'),
		);
	}

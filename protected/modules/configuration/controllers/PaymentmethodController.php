			...
			if(isset($_POST['create']))
             {
				...
				if($model->save())
					$this->redirect(array('paymentmethod/index',)); // $this->redirect(array('view','id'=>$model->id));
	...
	public function actionIndex()
	{
		...
		if(isset($_GET['PaymentMethod']))
			$model->attributes=$_GET['PaymentMethod'];
                    ...
                    $this->exportCSV(array(Yii::t('app','List of payment method: ')), null,false);
    ...
    public function behaviors() {
       return array(
           'exportableGrid' => array(
               ...
               'filename' => Yii::t('app','paymentmethod.csv'),
               'csvDelimiter' => ',',
               ));
    }

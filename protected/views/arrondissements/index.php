...
$this->menu=array(
		array('label'=>Yii::t('app',
				'List Arrondissements'), 'url'=>array('index')),
		array('label'=>Yii::t('app', 'Create Arrondissements'),
				'url'=>array('create')),
			);
		...
		Yii::app()->clientScript->registerScript('search', "
			...
			$('.search-form form').submit(function(){
				$.fn.yiiGridView.update('arrondissements-grid', {
data: $(this).serialize()
});
				return false;
				});
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'arrondissements-grid',
	'dataProvider'=>$model->search(),
	'filter'=>$model,
	'columns'=>array(
		'id',
		'arrondissement_name',
		array('name'=>'departement','value'=>'$data->departement0->department_name'),
		'date_created',
		'date_updated',
		'create_by',
		/*

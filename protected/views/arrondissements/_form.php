...
<?php echo $form->errorSummary($model); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'arrondissement_name'); ?>
<?php echo $form->textField($model,'arrondissement_name',array('size'=>45,'maxlength'=>45)); ?>
<?php echo $form->error($model,'arrondissement_name'); ?>
	</div>
...
<label for="Departments">Belonging Departments</label><?php 
